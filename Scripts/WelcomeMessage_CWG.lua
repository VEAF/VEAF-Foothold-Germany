...
local atisZones = {
    ...
    ["Schkeuditz"]         = {airbaseName = AIRBASE.GermanyCW.Schkeuditz},
    ...
    ["Bornholm"]           = {airbaseName = AIRBASE.GermanyCW.Bornholm},
    ["Sturup"]             = {airbaseName = AIRBASE.GermanyCW.Sturup},
    ["Kastrup City"]       = {airbaseName = AIRBASE.GermanyCW.Kastrup},
}
